            ...
            <div className="">
                ...
                <div className="mt-4 min-w-full overflow-hidden">
                    <div
                        ...
                        style={{width: "200%"}}>
                        <iframe className="h-100" style={{border: 0, width: "50%"}} src={CALENDAR_URL} />
                        <iframe className="h-100" style={{border: 0, width: "50%"}} src={CALENDAR_URL} />
                    </div>
                </div>

                <div>
                    <button onClick={navigate} className="text-[22px]">left</button>
                    <button onClick={navigate} className="text-[22px]">right</button>
                </div>
            </div>
        </>
    );
