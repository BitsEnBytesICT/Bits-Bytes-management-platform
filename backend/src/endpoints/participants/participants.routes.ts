...
class ParticipantRouter {
    ...
    initializeRoutes() {
        ...
        this.router.post('/api/participants/update', this.controller.update.bind(this.controller));
        this.router.delete('/api/participants/delete', this.controller.delete.bind(this.controller));
    }
